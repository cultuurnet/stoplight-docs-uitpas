...
Those discounts are payed via a third-party payer system in which the organizer of the event, the local government and the passholder each pay a percentage of the ticket price. Those payments are organized via a manual financial reporting flow within UiTPAS.